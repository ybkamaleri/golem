...
This function with parse your code and detect `@import` `@importFrom` and `::` to
add fill the Imports Fields in DESCRIPTION
...
About [attachment::att_amend_desc](https://thinkr-open.github.io/attachment/reference/att_amend_desc.html).
